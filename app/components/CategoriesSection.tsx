...
function CategoriesSection() {
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col items-center justify-between gap-8 my-6 sm:px-16 lg:my-0 lg:hidden  md:flex-row">
      <div className="flex h-10 w-60 divide-x divide-black border-black overflow-hidden rounded-lg  border">
          ...
          <div
            ...
            className={`flex w-1/3 items-center text-center justify-center ${
              pathname === link.href
                ...
                : 'text-gray-500 transition duration-200 hover:text-primary hover:font-medium hover:bg-gray-100 active:bg-gray-200'
            }`}
          >
